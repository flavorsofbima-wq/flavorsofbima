...
const META = {"avakaya": {"emoji": "🥭", "gradient": "linear-gradient(145deg,#1a0804,#5a1808,#9a2c10)", "shortDesc": "Classic Andhra raw mango pickle with rich red masala.", "description": "Our signature Avakaya — chunky raw mango pieces, fenugreek, mustard and rich red chilli masala, slow-set in wood pressed oil. Bold, tangy and unmistakably homemade.", "ingredients": ["Raw mango", "Red chilli powder", "Mustard", "Fenugreek", "Wood pressed oil", "Salt", "Garlic (optional)"], "badge": "🔥 #1 Seller"}, "tomato": {"emoji": "🍅", "gradient": "linear-gradient(145deg,#1a0808,#5a1818,#9a2828)", "shortDesc": "Tangy-spicy homemade tomato pickle.", "description": "Sun-ripened tomatoes cooked down with mustard, red chilli and Andhra spices into a thick, tangy pickle that pairs perfectly with rice, idly and dosa.", "ingredients": ["Tomato", "Red chilli powder", "Mustard", "Tamarind", "Wood pressed oil", "Salt", "Garlic (optional)"], "badge": ""}, "gongura": {"emoji": "🌿", "gradient": "linear-gradient(145deg,#0a1a0a,#1a5a1a,#2a8a2a)", "shortDesc": "Quintessential Andhra sorrel leaf pickle.", "description": "Tender gongura (sorrel) leaves slow-cooked with red chilli and spices into the tangy, bold pickle Andhra is famous for. A must with hot rice and ghee.", "ingredients": ["Gongura leaves", "Red chilli powder", "Mustard", "Wood pressed oil", "Salt", "Garlic (optional)"], "badge": "⭐ Most Ordered"}, "red-chilli": {"emoji": "🌶️", "gradient": "linear-gradient(145deg,#2a0808,#7a1010,#aa2020)", "shortDesc": "Fiery whole red chilli pickle.", "description": "For those who love the heat — plump red chillies stuffed with a mustard-forward masala and matured in wood pressed oil. Intense, bold and traditional.", "ingredients": ["Red chilli", "Mustard", "Fenugreek", "Wood pressed oil", "Salt"], "badge": ""}, "gongura-red-chilli": {"emoji": "🌿🌶️", "gradient": "linear-gradient(145deg,#0d1a0d,#2a5a2a,#4a8a4a)", "shortDesc": "Tangy gongura meets fiery red chilli.", "description": "Best of both worlds — the tang of gongura blended with the heat of red chilli in one perfectly balanced, bold jar.", "ingredients": ["Gongura leaves", "Red chilli", "Mustard", "Wood pressed oil", "Salt", "Garlic (optional)"], "badge": "🌟 Mix"}, "lemon": {"emoji": "🍋", "gradient": "linear-gradient(145deg,#1a1a08,#585810,#8a8820)", "shortDesc": "Bright, zesty lemon pickle.", "description": "Whole lemon pieces matured with warming spices into a bright, tangy, slightly sweet-sour pickle that cuts through any rich meal.", "ingredients": ["Lemon", "Red chilli powder", "Mustard", "Fenugreek", "Wood pressed oil", "Salt"], "badge": ""}, "gooseberry": {"emoji": "🫐", "gradient": "linear-gradient(145deg,#0a1a08,#285818,#408830)", "shortDesc": "Healthy, tangy amla pickle.", "description": "Nutrient-rich gooseberry (amla) pieces in a traditional Andhra spice blend — tangy, wholesome and full of goodness.", "ingredients": ["Gooseberry (amla)", "Red chilli powder", "Mustard", "Wood pressed oil", "Salt"], "badge": ""}, "chicken-boneless": {"emoji": "🍗", "gradient": "linear-gradient(145deg,#1a0808,#4a1010,#8a1a1a)", "shortDesc": "Tender boneless chicken in Andhra spices.", "description": "Small tender boneless chicken pieces cooked in an authentic Andhra spice blend — clearly visible meat, less masala, bold homemade taste. Set in wood pressed oil.", "ingredients": ["Boneless chicken", "Red chilli powder", "Ginger-garlic", "Andhra spices", "Wood pressed oil", "Salt"], "badge": "🌟 Premium"}, "gongura-chicken-boneless": {"emoji": "🍗🌿", "gradient": "linear-gradient(145deg,#0d1a0d,#3a4a10,#6a7a1a)", "shortDesc": "Boneless chicken in tangy gongura.", "description": "Tender boneless chicken marinated with tangy gongura (sorrel) and Andhra spices — the ultimate non-veg pickle combination.", "ingredients": ["Boneless chicken", "Gongura leaves", "Red chilli powder", "Ginger-garlic", "Wood pressed oil", "Salt"], "badge": "Must Try"}, "chicken-bone": {"emoji":"🍖","gradient":"linear-gradient(145deg,#1a0606,#4a0e0e,#8a1616)","shortDesc":"Bone-in chicken pickle, rich & traditional.","description":"Traditional country-style chicken pickle with bone-in cuts for deeper flavour, slow-cooked in an authentic Andhra spice blend and wood pressed oil.","ingredients":["Chicken (with bone)","Red chilli powder","Ginger-garlic","Andhra spices","Wood pressed oil","Salt"],"badge":"🍖 Traditional"},  "gongura-chicken-bone": {"emoji":"🍖🌿","gradient":"linear-gradient(145deg,#0d1a0a,#3a4a0e,#6a7a16)","shortDesc":"Bone-in chicken in tangy gongura.","description":"Country-style bone-in chicken pickle blended with tangy gongura (sorrel) and Andhra spices — bold, rustic and full of flavour.","ingredients":["Chicken (with bone)","Gongura leaves","Red chilli powder","Ginger-garlic","Wood pressed oil","Salt"],"badge":"Must Try"}, "garam-masala": {"emoji": "🌶️", "gradient": "linear-gradient(145deg,#1a0a04,#5a2a0a,#9a4810)", "shortDesc": "Freshly ground whole spice blend.", "description": "A warming, aromatic blend of whole spices roasted and ground fresh — the soul of Indian cooking.", "ingredients": ["Cardamom", "Cinnamon", "Clove", "Cumin", "Coriander", "Black pepper"], "badge": ""}, "dhaniya-powder": {"emoji": "🌿", "gradient": "linear-gradient(145deg,#1a1208,#5a4210,#9a7020)", "shortDesc": "Roasted & ground coriander powder.", "description": "Freshly roasted coriander seeds ground to a warm, citrusy powder that forms the base of countless curries.", "ingredients": ["Coriander seeds"], "badge": ""}, "jeera-powder": {"emoji": "🫘", "gradient": "linear-gradient(145deg,#18140a,#504018,#887828)", "shortDesc": "Hand-roasted cumin powder.", "description": "Nutty, earthy hand-roasted cumin ground fresh — essential for tempering, raita and spice blends.", "ingredients": ["Cumin seeds"], "badge": ""}, "bisibele-bath-powder": {"emoji": "🍛", "gradient": "linear-gradient(145deg,#1a0e08,#5a3210,#9a5820)", "shortDesc": "Signature blend for bisibelebath.", "description": "The complex, rich spice blend that gives Karnataka's famous bisibelebath its unmistakable flavour.", "ingredients": ["Chana dal", "Coriander", "Red chilli", "Cinnamon", "Clove", "Dry coconut"], "badge": ""}, "vangi-bath-powder": {"emoji": "🍆", "gradient": "linear-gradient(145deg,#0a1408,#2a4418,#4a7428)", "shortDesc": "Aromatic blend for brinjal rice.", "description": "A bold, nutty spice blend crafted for vangi bath (brinjal rice) — equally delicious with any vegetable rice.", "ingredients": ["Coriander", "Chana dal", "Urad dal", "Red chilli", "Dry coconut", "Cinnamon"], "badge": ""}, "sambar-powder": {"emoji": "🥣", "gradient": "linear-gradient(145deg,#1a0e06,#5a3410,#9a6020)", "shortDesc": "Homemade sambar masala.", "description": "A balanced, fragrant homemade sambar powder with the perfect depth for everyday sambar and stews.", "ingredients": ["Coriander", "Toor dal", "Chana dal", "Red chilli", "Fenugreek", "Curry leaves"], "badge": ""}, "rasam-powder": {"emoji": "🍵", "gradient": "linear-gradient(145deg,#16100a,#4a3410,#7a5a20)", "shortDesc": "Light & aromatic rasam blend.", "description": "A comforting, aromatic rasam powder that turns simple tamarind broth into soul-warming rasam.", "ingredients": ["Coriander", "Cumin", "Black pepper", "Red chilli", "Toor dal"], "badge": ""}, "curry-leaf-powder": {"emoji": "🌿", "gradient": "linear-gradient(145deg,#0a1a0a,#1a4a1a,#2a7a2a)", "shortDesc": "Fresh, greenish, aromatic podi.", "description": "Fresh curry leaves roasted and ground with lentils and spices into a nutritious, fragrant podi. Greenish, premium and packed with flavour.", "ingredients": ["Curry leaves", "Urad dal", "Chana dal", "Red chilli", "Salt"], "badge": "💚 Premium"}, "gun-powder": {"emoji": "🌶️", "gradient": "linear-gradient(145deg,#1a1008,#5a3010,#9a5020)", "shortDesc": "Fiery, punchy idly-dosa podi.", "description": "The classic fiery lentil podi — mix with ghee or oil and it transforms idly, dosa and plain rice into something unforgettable.", "ingredients": ["Urad dal", "Chana dal", "Red chilli", "Garlic", "Salt"], "badge": "🔥 Spicy Hit"}, "palli-karam-podi": {"emoji": "🥜", "gradient": "linear-gradient(145deg,#1a0e08,#4a2a10,#8a4820)", "shortDesc": "Roasted peanut karam podi.", "description": "Roasted peanuts ground with red chilli and garlic into a fiery, nutty podi — a Telugu kitchen staple loved with rice and ghee.", "ingredients": ["Peanuts", "Red chilli", "Garlic", "Cumin", "Salt"], "badge": ""}, "vellulli-karam-podi": {"emoji": "🧄", "gradient": "linear-gradient(145deg,#14100a,#3a3010,#6a5820)", "shortDesc": "Bold garlic karam podi.", "description": "An intensely flavoured garlic podi — pungent, rich and bold. A little goes a long way over rice, idly or dosa.", "ingredients": ["Garlic", "Red chilli", "Urad dal", "Salt"], "badge": ""}, "flax-seeds-podi": {"emoji": "🌾", "gradient": "linear-gradient(145deg,#100e0a,#302e18,#5a5828)", "shortDesc": "Nutritious roasted flax podi.", "description": "Roasted flax seeds ground with mild spices into an omega-rich, healthy podi with a subtle nutty warmth.", "ingredients": ["Flax seeds", "Red chilli", "Garlic", "Cumin", "Salt"], "badge": ""}, "poha-mixture": {"emoji": "🍚", "gradient": "linear-gradient(145deg,#1a1408,#4a3c14,#8a7024)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "murukulu": {"emoji": "🥨", "gradient": "linear-gradient(145deg,#1a1208,#5a3c14,#9a6a24)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "pappu-chekkalu": {"emoji": "🍘", "gradient": "linear-gradient(145deg,#181206,#4a3410,#8a6020)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "ribbon-pakoda": {"emoji": "🎀", "gradient": "linear-gradient(145deg,#1a1006,#5a3410,#9a5e1c)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "palli-chikki": {"emoji": "🥜", "gradient": "linear-gradient(145deg,#1a0e06,#4a2a0e,#8a4e1a)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "wheat-biscuits": {"emoji": "🍪", "gradient": "linear-gradient(145deg,#181008,#4a3014,#8a5c28)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "kaju-pakodi": {"emoji": "🥮", "gradient": "linear-gradient(145deg,#1a1408,#503c14,#907028)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "dry-fruit-laddu": {"emoji": "🍡", "gradient": "linear-gradient(145deg,#160e08,#442814,#7a4c24)", "shortDesc": "", "description": "", "ingredients": [], "badge": "💚 No Sugar"}, "sunnundalu-bellam": {"emoji": "🟤", "gradient": "linear-gradient(145deg,#140c06,#402410,#74461c)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "sunnundalu-sugar": {"emoji": "⚪", "gradient": "linear-gradient(145deg,#181410,#48402c,#847a5c)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "boondi-mixture": {"emoji": "🥣", "gradient": "linear-gradient(145deg,#1a1206,#5a3810,#9a641c)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "boondi-laddu-sugar": {"emoji": "🟡", "gradient": "linear-gradient(145deg,#1a1606,#5a4810,#9a7e1c)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "boondi-laddu-bellam": {"emoji": "🟠", "gradient": "linear-gradient(145deg,#1a1006,#563210,#96581c)", "shortDesc": "", "description": "", "ingredients": [], "badge": ""}, "ariselu-bellam": {"emoji": "🍮", "gradient": "linear-gradient(145deg,#160e06,#462810,#82501c)", "shortDesc": "", "description": "", "ingredients": [], "badge": "Festive"}};
...
function main() {
  ...
  for (let r = dataStart; r < pr.length; r++) {
    ...
    // Description & ingredients now come from the Excel (per-product).
    // If a cell is blank, fall back to the built-in META text.
    const xlDesc = String(get(row, "description") ?? "").trim();
    const xlIngRaw = String(get(row, "ingredients") ?? "").trim();
    // Ingredients may be comma-separated OR one per line (or bulleted).
    const xlIngredients = xlIngRaw
      ? xlIngRaw
          .split(/\r?\n|,/)                       // split on newlines or commas
          .map((s) => s.replace(/^[\s•\-*\u2022]+/, "").trim())  // strip bullets/dashes
          .filter(Boolean)
      : null;

    const description = xlDesc || meta.description;
    const ingredients = xlIngredients && xlIngredients.length ? xlIngredients : meta.ingredients;
    // shortDesc: first sentence of the description (used on cards)
    const shortDesc = xlDesc
      ? (xlDesc.split(/(?<=\.)\s/)[0] || xlDesc).trim()
      : meta.shortDesc;

    // Per-product notes shown under the buy buttons
    const shelfLife = String(get(row, "shelf_life") ?? "").trim();
    const availabilityNote = String(get(row, "availability_note") ?? "").trim();
    ...
    products.push({
      ...
      ...meta,
      // Excel wins over META for these:
      description,
      ingredients,
      shortDesc,
      shelfLife,
